<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/Prueba2.aspx.cs" Inherits="view_Prueba2" %>
    ...
    <form id="form1" runat="server">
	    ...
	    <article class="contenido-principal">
		  <h1 class="animated wobble">¿Adivina que tipo de animal soy?</h1>
		    <img src="../imagenes/Hipopotamo.png" alt="logo" style="height: 356px; width: 24%;"/>
            <p class="animated slideInUp">Escribe la respuesta en la cajita</p>
            <br />
            <input type="text" id="anima2" class="input" />
            <br />
            <br />
            <a class="botton" href="Vertebrados.aspx">SIGUIENTE</a>
         </article>
        </section>
    </form>
</body>
