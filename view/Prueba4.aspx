<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/Prueba4.aspx.cs" Inherits="view_Prueba4" %>
    ...
    <form id="form1" runat="server">
	    ...
	    <article class="contenido-principal">
		  <h1 class="animated wobble">¿Adivina que tipo de animal soy?</h1>
		    <img src="../imagenes/Salamandra.png" alt="logo" style="height: 356px; width: 24%;"/>
            ...
            <a class="botton" href="Animales.aspx">Empezar</a>
         </article>
        </section>
    </form>
</body>
